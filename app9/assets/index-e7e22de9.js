...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    function getAudioUrl() {
      return new URL(song, window.location.href);
    }
    onMounted(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("h3", null, toDisplayString(unref(title)), 1),
...
const _hoisted_18 = ["id", "aria-labelledby", "data-bs-parent"];
const _hoisted_19 = { class: "list-group list-group-flush" };
const _hoisted_20 = { class: "list-group-item" };
const _hoisted_21 = ["id"];
const _hoisted_22 = { class: "card" };
const _hoisted_23 = ["id"];
const _hoisted_24 = { class: "mb-0" };
const _hoisted_25 = ["data-bs-target", "aria-controls"];
const _hoisted_26 = ["id", "aria-labelledby", "data-bs-parent"];
const _hoisted_27 = { class: "card-body text-center" };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(true), createElementBlock(Fragment, null, renderList(props.data, (item) => {
        return openBlock(), createElementBlock("div", null, [
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("div", {
              id: `accordion${underScore(item.album.title)}`
            }, [
              ...
              createBaseVNode("div", _hoisted_5, [
                createBaseVNode("h5", _hoisted_6, [
                  createTextVNode(toDisplayString(item.album.title) + " - ", 1),
                  createBaseVNode("span", _hoisted_7, toDisplayString(item.album.type), 1)
                ]),
                createBaseVNode("p", _hoisted_8, [
                  createBaseVNode("a", {
                    href: item.album.link.spotify,
                    class: "card-link"
                  }, _hoisted_11, 8, _hoisted_9),
                  createBaseVNode("a", {
                    href: item.album.link.appleMusic,
                    class: "card-link"
                  }, _hoisted_14, 8, _hoisted_12),
                  createBaseVNode("a", {
                    href: item.album.link.youtube,
                    class: "card-link"
              ...
              createBaseVNode("div", {
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(item.songList, (song) => {
                  return openBlock(), createElementBlock("ul", _hoisted_19, [
            ...
            createBaseVNode("div", {
              id: `accordion${underScore(item.album.title)}Links`
            }, [
              createBaseVNode("div", _hoisted_22, [
                createBaseVNode("div", {
                  class: "card-header",
                  id: `heading${underScore(item.album.title)}Links`
                }, [
                  createBaseVNode("h5", _hoisted_24, [
                    createBaseVNode("button", {
                      class: "btn btn-link",
                      "data-bs-toggle": "collapse",
                    ...
                    }, " Check out " + toDisplayString(item.artist.name) + " through their official links ", 9, _hoisted_25)
                  ])
                ], 8, _hoisted_23),
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_27, [
                    createBaseVNode("a", {
                      href: item.artist.link.spotify,
                      class: "card-link"
                    }, _hoisted_30, 8, _hoisted_28),
                    createBaseVNode("a", {
                      href: item.artist.link.appleMusic,
                      class: "card-link"
                    }, _hoisted_33, 8, _hoisted_31),
                    createBaseVNode("a", {
                      href: item.artist.link.youtube,
                      class: "card-link"
...
const data = [
  {
    album: {
      ...
      releaseYear: "2022",
      link: {
        spotify: "https://open.spotify.com/album/3NIYEFumivWNnMPM5IE31G",
    ...
    artist: {
      name: "Clearpine",
      link: {
        spotify: "https://open.spotify.com/artist/1rSWlcQsS2wj8kT7DlZbLN",
        appleMusic: "https://music.apple.com/us/artist/clearpine/1588166077",
        youtube: "https://www.youtube.com/channel/UCrru1VDK5Q01FC0HkR_R_yg"
      }
    },
    songList: [
      {
  ...
  },
  {
    album: {
      ...
      releaseYear: "2021",
      link: {
        spotify: "https://open.spotify.com/album/5TCin0FLgZSryLHSGtKvVv",
  ...
  },
  {
    album: {
      ...
      releaseYear: "2021",
      link: {
        spotify: "https://open.spotify.com/album/7nsJxmPONq2NptEoLzLgqY",
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$1, { data: unref(data) }, null, 8, ["data"]);
    };
  }
};
const main = "";
