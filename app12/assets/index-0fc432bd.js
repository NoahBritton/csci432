...
const Nav_vue_vue_type_style_index_0_scoped_487f82b3_lang = "";
...
const _hoisted_3$1 = { class: "navbar-nav mr-auto" };
const _hoisted_4$1 = { class: "nav-item" };
const _hoisted_5 = { class: "nav-link" };
const _hoisted_6 = { class: "nav-item" };
const _hoisted_7 = { class: "nav-link" };
const _sfc_main$6 = {
  __name: "Nav",
  setup(__props) {
    return (_ctx, _cache) => {
...
const Nav = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-487f82b3"]]);
const _sfc_main$5 = {
  __name: "App",
  setup(__props) {
    return (_ctx, _cache) => {
...
const _sfc_main$4 = {};
const _hoisted_1$3 = /* @__PURE__ */ createBaseVNode("h1", null, "Home", -1);
const _hoisted_2$2 = /* @__PURE__ */ createBaseVNode("img", { src: "https://picsum.photos/700" }, null, -1);
...
const HomeView = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render]]);
const data = [
  {
    item1: {
      id: "blue rock",
      img_url: "app12/imgs/blue_rock.jpg",
      description: "Blue rock - Micah"
    },
    item2: {
      id: "strand hunter",
      img_url: "app12/imgs/strand_hunter.jpg",
      description: "The class I most often play in Destiny 2 right now"
    },
    item3: {
      id: "fire punch",
      img_url: "app12/imgs/fire_punch.jpg",
      description: "playing Lightfall"
    },
    item4: {
      id: "sigh",
      img_url: "app12/imgs/sigh.jpg",
      description: "buying lightfall"
    }
  }
];
const ItemsView_vue_vue_type_style_index_0_scoped_d96172d3_lang = "";
const _withScopeId = (n) => (pushScopeId("data-v-d96172d3"), n = n(), popScopeId(), n);
const _hoisted_1$2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", null, "Search Items", -1));
const _hoisted_2$1 = { class: "search-container" };
const _hoisted_3 = ["onSubmit"];
const _hoisted_4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("button", { type: "submit" }, "🔍", -1));
const _sfc_main$3 = {
  __name: "ItemsView",
  setup(__props) {
    const items = data[0];
    ...
    function submitSearch() {
      if (searchTerm.value.trim()) {
        let id = searchTerm.value.toLowerCase().replace(/ /g, "_");
...
const ItemshView = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-d96172d3"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    console.log(imgUrl);
    function createURL() {
      return new URL(imgUrl, baseUrl);
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("img", {
        src: createURL(unref(imgUrl))
      }, null, 8, _hoisted_1$1);
    };
  }
};
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("h1", null, toDisplayString(unref(description)), 1);
    };
  }
};
const ItemView_vue_vue_type_style_index_0_scoped_45da3650_lang = "";
const _hoisted_1 = { class: "item" };
const _hoisted_2 = { class: "item-content" };
const _sfc_main = {
  __name: "ItemView",
  props: ["imgUrl", "Description"],
  setup(__props) {
    const items = data[0];
    let imageUrl = "";
    let itemTitle = "";
    let itemDescription = "";
    const router2 = useRouter();
    let id = router2.currentRoute.value.params.itemId;
    for (const key in items) {
      if (items[key].id.replace(/ /g, "_") == id) {
        imageUrl = items[key].img_url;
        itemDescription = items[key].description;
        itemTitle = id.split("_").map((word) => word.charAt(0).toUpperCase() + word.slice(1)).join(" ");
      }
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("h1", null, toDisplayString(unref(itemTitle)), 1),
        createBaseVNode("div", _hoisted_2, [
          createVNode(_sfc_main$2, { imgUrl: unref(imageUrl) }, null, 8, ["imgUrl"]),
          createVNode(_sfc_main$1, { Description: unref(itemDescription) }, null, 8, ["Description"])
        ])
      ]);
    };
  }
};
const ItemView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-45da3650"]]);
